export const VERSION = globalThis._VERSION||''

export const ENV = globalThis._ENV||{}
...
export const PROBABLY_MOBILE = globalThis.matchMedia?.('screen and (max-device-width:480px)').matches
