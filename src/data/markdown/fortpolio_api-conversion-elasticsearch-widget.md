...
cv:
  ...
  project: Elasticsearch widget
  body: |
    - Implemented and styled an education widget.
    - Updated code to accommodate API changes affecting Elasticsearch backend.
cvNl:
  body: |
    - Implementatie en vormgeving van Education Widget voor het Ministerie van Onderwijs van de Nederlandse Antillen.
    - Update van code met betrekking tot API aanpassingen in de Elasticsearch backend.
...
clients: [Ministry of Education, Nederlandse Antillen]
...
<small>Ministry of Education, Culture, Youth and Sports, Division for Educational Innovations</small>