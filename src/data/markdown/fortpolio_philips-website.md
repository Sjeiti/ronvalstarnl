...
cv:
  ...
  project: Philips design system
  body: |
    - Transformed demo into production-ready reusable components.
...
cvNl:
  body: |
    - De demo omgezet naar herbruikbare componenten die klaar zijn voor productie.
    - Richtlijnen voor het coderen van toekomstige componenten opgesteld.
    - Complexe componenten en voorbeeldcomponenten geïmplementeerd.
    - Documentatiegeneratie op basis van JSDoc opgezet.
