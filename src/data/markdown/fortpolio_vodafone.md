...
cv:
  ...
  project: Vodafone webshop SPA
  body: |
    - Rebuilt shop flow as a single-page application using Angular.
    - Enhanced build processes and refactored legacy code.
    - Improved overall code quality.
cvNl:
  body: |
    - De shop-flow herbouwd als een single-page applicatie met behulp van Angular.
