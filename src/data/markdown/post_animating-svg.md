...
[SVGator](https://app.svgator.com) is a good option, although it is not as easy to use as Adobe Animate (two dollars cheaper though). It is an online web application. You can try it out, although the 14-day trial sucks a bit because it doesn't unlock all the possibilities.
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" width="32" height="32" viewBox="0 0 32 32" xml:space="preserve">
  <style>
        @keyframes www {
